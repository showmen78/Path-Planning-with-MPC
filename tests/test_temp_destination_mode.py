...
class TempDestinationModeTests(unittest.TestCase):
    ...
    def test_normal_mode_blue_dot_uses_route_progress_but_aligns_to_selected_lane(self):
    ...
    def test_intersection_mode_blue_dot_does_not_snap_without_lane_change_decision(self):
    ...
    def test_intersection_mode_reference_samples_do_not_snap_without_lane_change_decision(self):
