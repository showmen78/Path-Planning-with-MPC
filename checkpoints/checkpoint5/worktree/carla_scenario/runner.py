...
def _print_route_plan_summary(tag: str, route_summary: RoutePlanSummary) -> None:
    ...
    if int(getattr(route_summary, "start_graph_index", -1)) >= 0:
        print(
            ...
            f"xy={getattr(route_summary, 'start_graph_xy', None)} "
    ...
    if int(getattr(route_summary, "goal_graph_index", -1)) >= 0:
        print(
            ...
            f"xy={getattr(route_summary, 'goal_graph_xy', None)} "
    ...
    print(f"route_waypoints[{len(route_summary.route_waypoints)}] = {route_summary.route_waypoints}")
...
def run_loaded_world(client, world, scenario_cfg: Mapping[str, object], carla) -> int:
    ...
    try:
        ...
        while True:
            ...
            base_route_summary = global_planner.plan_route(
            ...
            maneuver_route_summary = global_planner.plan_route(
