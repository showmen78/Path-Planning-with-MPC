    ...
    try:
        ...
        while True:
            ...
            if mpc.should_replan(sim_time_s):
                ...
                reroute_target_lane_id_override = None
                ...
                if str(current_applied_behavior) == "reroute":
                    ...
                    if rerouted_route_summary is not None and len(rerouted_route_points) > 0:
                        ...
                        reroute_target_lane_id_override = int(
                            _clamp_lane_id_to_allowed(
                ...
                selected_lane_id = _clamp_lane_id_to_allowed(
                    int(
                        current_lane_id
                        if reroute_target_lane_id_override is None
                        else reroute_target_lane_id_override
                    )
                    if str(current_applied_behavior) == "reroute"
                    else int(planner_output.get("target_lane_id", current_lane_id)),
                    local_allowed_lane_ids,
                )
