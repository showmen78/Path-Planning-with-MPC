    ...
    try:
        ...
        while True:
            ...
            if mpc.should_replan(sim_time_s):
                ...
                traffic_signal_context = None
                if bool(traffic_light_stop_enabled):
                    traffic_stop_target = find_stop_target_from_ego(
                        world_map=world_map,
                        carla=carla,
                        ego_transform=ego_transform,
                    ...
                    traffic_signal_context = find_relevant_signal_context(
                        world=world,
                    ...
                    traffic_signal_state = str(
                        (traffic_signal_context or {}).get("signal_state", "unknown")
                    )
